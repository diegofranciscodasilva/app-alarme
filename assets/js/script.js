const timerRef = document.querySelector('.current__time')
const hourInput = document.getElementById('hour__input')
const minuteInput = document.getElementById('minute__input')
const activeAlarms = document.querySelector('.alarms__list')
...
setAlarm.addEventListener('click', () => {
    ...
    if(hour < 0 || hour > 23 || minute < 0 || minute > 59) {
        alert('hora ou minutos inválidos !')
        return
    }
